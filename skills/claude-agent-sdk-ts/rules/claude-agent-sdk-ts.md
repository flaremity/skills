...
- **Named imports only:** Use `import { query, tool, listSessions, getSessionMessages, renameSession, type AgentInfo, type FastModeState, type OnElicitation, type ElicitationRequest, type ElicitationResult, type SDKRateLimitInfo, type Settings, type ToolConfig, type SessionMutationOptions } from "@anthropic-ai/claude-agent-sdk"` (NOT default import)
