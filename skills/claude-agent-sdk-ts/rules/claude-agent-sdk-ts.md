...
- **Named imports only:** Use `import { query, tool, listSessions, getSessionMessages, forkSession, getSessionInfo, renameSession, tagSession, type AgentInfo, type FastModeState, type OnElicitation, type ElicitationRequest, type ElicitationResult, type SDKRateLimitInfo, type SDKAPIRetryMessage, type StopFailureHookInput, type Settings, type ToolConfig, type ForkSessionOptions, type ForkSessionResult, type SessionMutationOptions, type SDKControlRequest, type SDKControlResponse } from "@anthropic-ai/claude-agent-sdk"` (NOT default import)
